            ...
            <div className="flex flex-col items-center justify-center min-h-[50vh] sm:min-h-[60vh] text-center px-4 w-full">
                <div className="relative mb-6 sm:mb-8">
                    <div
                        ...
                        shadow-[0_0_30px_rgba(34,211,238,0.6),0_0_60px_rgba(236,72,153,0.4),0_0_90px_rgba(34,211,238,0.2)]
                    `}
                    >
                        <Image
                            src={picture}
                    ...
                    <div
                        ...
                        hover:animate-spin hover:shadow-[0_0_25px_rgba(34,197,94,0.9)]
                    `}
                    >
                        ✨
                    </div>
